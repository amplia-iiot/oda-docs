...
To listen for traps that devices send, we define the port where we will be listening:
* __trapListenPort__: _Required data_. Port where we listen for events sent by devices (like SNMP Traps).
